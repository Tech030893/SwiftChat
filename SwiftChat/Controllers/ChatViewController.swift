...
final class ChatViewController: MessagesViewController
{
    ...
    private func setupInputButton()
    {
        ...
        button.tintColor = UIColor(named: "InputBarButtonItemColor")
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any])
    {
        ...
        if let image = info[.editedImage] as? UIImage, let imageData = image.pngData() {
            ...
            StorageManager.shared.uploadMessagePhoto(with: imageData, fileName: fileName, completion: { [weak self] result in
                ...
                case .success(let urlString):
                    ...
                    print("Photo Message Uploaded: \(urlString)")
        ...
        else if let videoUrl = info[.mediaURL] as? URL
        {
            ...
            StorageManager.shared.uploadMessageVideo(with: videoUrl, fileName: fileName, completion: { [weak self] result in
                ...
                case .success(let urlString):
                    // Ready to send message
                    print("Video Message Uploaded: \(urlString)")
...
extension ChatViewController: MessagesDataSource, MessagesLayoutDelegate, MessagesDisplayDelegate
{
    ...
    func backgroundColor(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> UIColor
    {
        ...
        if sender.senderId == selfSender?.senderId
        {
            ...
            return UIColor(named: "MessageBubbleSenderBGColor")!
        }
        return UIColor(named: "MessageBubbleReceiverBGColor")!
    }
    ...
    func configureAvatarView(_ avatarView: AvatarView, for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView)
    {
        ...
        if sender.senderId == selfSender?.senderId
        {
            ...
            {
                // images/safeEmail_profile_picture.png -> images stored under this url
                guard let email = UserDefaults.standard.value(forKey: "email") as? String else {
                    return
                }
                let safeEmail = DatabaseManager.safeEmail(emailAddress: email)
