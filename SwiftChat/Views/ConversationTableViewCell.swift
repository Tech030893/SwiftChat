...
class ConversationTableViewCell: UITableViewCell
{
    ...
    override func layoutSubviews()
    {
        ...
        userMessageLabel.frame = CGRect(x: userImageView.right + 10, y: userNameLabel.bottom + 0, width: contentView.width - 20 - userImageView.width, height: (contentView.height-20)/2)
    }
